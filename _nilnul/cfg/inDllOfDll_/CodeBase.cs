...
namespace _nilnul.cfg.inDllOfDll_
{
	/* 
...
In particular, the AppDomain.CurrentDomain.SetupInformation.ConfigurationFile setting. – Marc Gravell♦ Feb 27 '09 at 11:06 
	 */
	static public class _CodeBaseX
	{
		
		static public string Linq(string key) {
			...
			return dllConfig.ConnectionStrings.ConnectionStrings[key ].ConnectionString;
		}
