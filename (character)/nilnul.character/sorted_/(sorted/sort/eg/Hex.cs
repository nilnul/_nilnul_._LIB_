...
namespace nilnul.character.sort.eg
{
	...
	public class Hex
	{
		...
		static public readonly string Lower = GenerateLower();

		static public readonly string Upper = GenerateUpper();

		static public string GenerateLower() {
			return Digit.Generated + HexLatin.Lower;
		}

		static public string GenerateUpper() {
			return Digit.Generated + HexLatin.Upper;
		}
