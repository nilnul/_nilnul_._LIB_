...
namespace nilnul.character.sort.eg
{
	...
	/// </summary>
	public class HexLatin
	{
		 public const string Upper = "ABCDEF";

		//public static readonly string Upper = Digit.Generated + UpperAlpha;




		static public readonly string Lower = Upper.ToLower();
